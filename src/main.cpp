...
void setup() {
    ...
    car = LineTraceCarBuilder()
            ...
            .SetMidReflector(new PhotoReflectorImpl(FRONT_MID_PHOTO_REFLECTOR_PIN, PHOTO_REFLECTOR_THRESHOLD, "Mid"))
            .SetRightReflector(new PhotoReflectorImpl(FRONT_RIGHT_PHOTO_REFLECTOR_PIN, PHOTO_REFLECTOR_THRESHOLD, "Right"))
            .SetLeftReflector(new PhotoReflectorImpl(FRONT_LEFT_PHOTO_REFLECTOR_PIN, PHOTO_REFLECTOR_THRESHOLD, "Left"))
            .Build();
